...
double power_recursive(double number, int exp);
...
double power(double number, int exp) {
  ...
  return power_recursive(number, exp);
}

double negative_power(double number, int exp) {
  return 1 / power_recursive(number, -exp);
}
...
double power_recursive(double number, int exp) {
  ...
  return number * power_recursive(number, exp - 1);
}